# Tamacodex Asset Contract

Use this reference when generating milestone pawn assets with `tamacodex_gen`.
...
```json
{
  ...
  "displayName": "Ducky",
  "inspiration": "a duck",
  "description": "A tidy duck-inspired Tamacodex companion.",
  "family": "duck",
  "palette": {
    "main": "#fff4a8",
    "shade": "#d59a3a"
