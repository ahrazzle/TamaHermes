...
class PreviewRuntime:
    def __init__(self, catalog: Catalog, state_path: Path, codex_home: Path) -> None:
        ...
        self.cache_dir = codex_home / "tamacodex" / "preview"
...
<main class="surface">
  <section class="pet-wrap" id="petWrap">
    ...
    <div class="pet" id="pet" role="img" aria-label="Tamacodex"></div>
  </section>
  <nav class="actions" aria-label="Tamacodex actions">
...
def make_handler(runtime: PreviewRuntime):
    class Handler(BaseHTTPRequestHandler):
        server_version = "TamacodexPreview/0.3"
