...
def sfx_payload() -> dict[str, Any]:
    return {
        "schema": "tamacodex.preview_sfx.v1",
        ...
        "boundary": "Preview payload for shared Tamacodex SFX; Codex native custom pet overlay does not load these sounds.",
    }
...
def read_sfx_bytes(filename: str) -> bytes:
    ...
    return files("tamacodex").joinpath("sfx", filename).read_bytes()
